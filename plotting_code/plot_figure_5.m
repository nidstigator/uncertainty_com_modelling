...
figures_path = '../figures_output/Figure6/';
...
[s_1, s_2, t,y_1,y_2,y_5,y_6, y_1_tw,y_2_tw,y_5_tw,y_6_tw] = ...
    calculate_mean_activity(dynamics_and_results, 3.2, ...
    is_motor_correct, is_motor_com, is_late_com);


response_average = find(abs(y_5-y_6)>17.4,1);
plot_time_window(dynamics_and_results,y_1_tw,y_2_tw,100,10,y_5_tw,y_6_tw,is_late_com)
...
plot(s_1(start:20:ending),s_2(start:20:ending),'.','MarkerSize',15,'Color',[0 0 0]);
...
pubgraph(gcf,28,4,'w')
if(export)
export_path = [figures_path 'phase_plane_epoch1'];
...
function plot_time_window(dynamics_and_results,activity_vector1,activity_vector2,time_wind,slide_wind,y_5,y_6,late)
global legends;
global titles;
global export;
global figures_path;
...
stim_onset =  dynamics_and_results(1).stim_onset;
...
x=1000:2000;
y=0;
plot(x,y*ones(size(x)),'LineWidth',4,'LineStyle','--','Color',[0.5 0.5 0.5]);
...
function[s_1,s_2,t,y_1_mean,y_2_mean,y_5_mean,y_6_mean, y_1_tw,y_2_tw,y_5_tw,y_6_tw] = ...
...
y_mc_hu(1,:) = mean(y_mc_hu_gather);


y_1_tw = calculate_time_window(y_1_mean,100,10);
y_2_tw = calculate_time_window(y_2_mean,100,10);
y_5_tw = calculate_time_window(y_5_mean,100,10);
y_6_tw = calculate_time_window(y_6_mean,100,10);

[~, t]= max(y_mc_hu);
[s_1,s_2] = convert_y_to_s(y_1_mean,y_2_mean);
