...
plot_nullcline(x_null_x,x_null_y,y_null_x,y_null_y,s_1,s_2,stim_onset,t)
...
t = dynamics_and_results(index_to_plot).movement_duration+dynamics_and_results(index_to_plot).response_time;
